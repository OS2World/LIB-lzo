...
#define LZO1B_MEM_COMPRESS      ((lzo_uint) (16384L * sizeof(lzo_byte *)))
...
#define LZO1B_99_MEM_COMPRESS   ((lzo_uint) (65536L * sizeof(lzo_byte *)))
...
#define LZO1B_999_MEM_COMPRESS  ((lzo_uint) (3 * 65536L * sizeof(lzo_uint32)))
